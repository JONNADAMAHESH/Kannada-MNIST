...
# Ensure the dimensions of your data before applying PCA
print("Train data shape:", X_train.shape)
print("Test data shape:", X_test.shape)

# Choose a reasonable number of components based on your data dimensions
component_size = min(X_train.shape[0], X_train.shape[1]) // 2  # For instance, using half the number of features
...
for component_size in component_sizes:
    # Ensure the chosen component size is within the available dimensions
    component_size = min(component_size, X_train.shape[0], X_train.shape[1])
